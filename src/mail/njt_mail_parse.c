...
njt_int_t
njt_mail_pop3_parse_command(njt_mail_session_t *s)
{
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != NJT_POP3_AUTH) ? sw_start : sw_argument;
...
njt_int_t
njt_mail_imap_parse_command(njt_mail_session_t *s)
{
            ...
            if (ch == ' ' || ch == CR || ch == LF) {
                ...
                case 12:
                    if ((c[0] == 'A'|| c[0] == 'a')
                        ...
                        && (c[11] == 'E'|| c[11] == 'e'))
                    {
                        s->command = NJT_IMAP_AUTHENTICATE;
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != NJT_IMAP_AUTHENTICATE) ? sw_start : sw_argument;
...
njt_int_t
njt_mail_smtp_parse_command(njt_mail_session_t *s)
{
    u_char      ch, *p, *c, c0, c1, c2, c3;
    njt_str_t  *arg;
    enum {
        ...
        case sw_command:
            if (ch == ' ' || ch == CR || ch == LF) {
                ...
                if (p - c == 4) {
                    ...
                    {
                        s->command = NJT_SMTP_HELO;

                    } else if (c0 == 'E' && c1 == 'H' && c2 == 'L' && c3 == 'O')
                    {
                        s->command = NJT_SMTP_EHLO;

                    } else if (c0 == 'Q' && c1 == 'U' && c2 == 'I' && c3 == 'T')
                    {
                        s->command = NJT_SMTP_QUIT;

                    } else if (c0 == 'A' && c1 == 'U' && c2 == 'T' && c3 == 'H')
                    {
                        s->command = NJT_SMTP_AUTH;

                    } else if (c0 == 'N' && c1 == 'O' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = NJT_SMTP_NOOP;

                    } else if (c0 == 'M' && c1 == 'A' && c2 == 'I' && c3 == 'L')
                    {
                        s->command = NJT_SMTP_MAIL;

                    } else if (c0 == 'R' && c1 == 'S' && c2 == 'E' && c3 == 'T')
                    {
                        s->command = NJT_SMTP_RSET;

                    } else if (c0 == 'R' && c1 == 'C' && c2 == 'P' && c3 == 'T')
                    {
                        s->command = NJT_SMTP_RCPT;

                    } else if (c0 == 'V' && c1 == 'R' && c2 == 'F' && c3 == 'Y')
                    {
                        s->command = NJT_SMTP_VRFY;

                    } else if (c0 == 'E' && c1 == 'X' && c2 == 'P' && c3 == 'N')
                    {
                        s->command = NJT_SMTP_EXPN;

                    } else if (c0 == 'H' && c1 == 'E' && c2 == 'L' && c3 == 'P')
                    {
                        s->command = NJT_SMTP_HELP;
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != NJT_SMTP_AUTH) ? sw_start : sw_argument;
...
njt_int_t
njt_mail_auth_parse(njt_mail_session_t *s, njt_connection_t *c)
{
    njt_str_t                 *arg;
    ...
    if (arg[0].len == 5) {
        ...
        if (njt_strncasecmp(arg[0].data, (u_char *) "LOGIN", 5) == 0) {

            if (s->args.nelts == 1) {
                return NJT_MAIL_AUTH_LOGIN;
            }

            if (s->args.nelts == 2) {
                return NJT_MAIL_AUTH_LOGIN_USERNAME;
            }

            return NJT_MAIL_PARSE_INVALID_COMMAND;
        }

        if (njt_strncasecmp(arg[0].data, (u_char *) "PLAIN", 5) == 0) {

            if (s->args.nelts == 1) {
                return NJT_MAIL_AUTH_PLAIN;
            }

            if (s->args.nelts == 2) {
                return njt_mail_auth_plain(s, c, 1);
            }
        }
    ...
    if (arg[0].len == 8) {
        ...
        if (njt_strncasecmp(arg[0].data, (u_char *) "CRAM-MD5", 8) == 0) {

            if (s->args.nelts != 1) {
                return NJT_MAIL_PARSE_INVALID_COMMAND;
            }

            return NJT_MAIL_AUTH_CRAM_MD5;
        }

        if (njt_strncasecmp(arg[0].data, (u_char *) "EXTERNAL", 8) == 0) {

            if (s->args.nelts == 1) {
                return NJT_MAIL_AUTH_EXTERNAL;
            }

            if (s->args.nelts == 2) {
                return njt_mail_auth_external(s, c, 1);
            }
        }
