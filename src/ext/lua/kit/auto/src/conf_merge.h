...
#define     ndk_conf_merge_value            njt_conf_merge_value
#define     ndk_conf_merge_off_value        njt_conf_merge_off_value 
#define     ndk_conf_merge_ptr_value        njt_conf_merge_ptr_value
#define     ndk_conf_merge_str_value        njt_conf_merge_str_value
#define     ndk_conf_merge_size_value       njt_conf_merge_size_value 
