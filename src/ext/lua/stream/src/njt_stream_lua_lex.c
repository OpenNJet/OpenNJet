 ...
 *
 * src/subsys/njt_subsys_lua_lex.c.tt2
 */
...
/*
 * njt_stream_lua_lex: the "ovec" array should be allocated by the
 * caller with at least 2 elements.
 */
int
njt_stream_lua_lex(const u_char *const s, size_t len, int *const ovec)
{
    unsigned i = 0;
    int matched_0 = -1;
    int matched_1 = -1;
