 ...
 *
 * src/subsys/njt_subsys_lua_input_filters.c.tt2
 */
...
njt_int_t
njt_stream_lua_read_bytes(njt_buf_t *src, njt_chain_t *buf_in,
...
njt_int_t
njt_stream_lua_read_all(njt_buf_t *src, njt_chain_t *buf_in,
...
njt_int_t
njt_stream_lua_read_any(njt_buf_t *src, njt_chain_t *buf_in, size_t *max,
    ssize_t bytes, njt_log_t *log)
{
    if (bytes == 0) {
        return NJT_ERROR;
...
njt_int_t
njt_stream_lua_read_line(njt_buf_t *src, njt_chain_t *buf_in,
    ssize_t bytes, njt_log_t *log)
{
    u_char                      *dst;
    u_char                       c;
