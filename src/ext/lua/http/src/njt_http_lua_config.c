...
static int njt_http_lua_config_prefix(lua_State *L);
static int njt_http_lua_config_data_prefix(lua_State *L);
static int njt_http_lua_config_log_prefix(lua_State *L);
static int njt_http_lua_config_configure(lua_State *L);
...
njt_http_lua_inject_config_api(lua_State *L)
{
    ...
    lua_pushcfunction(L, njt_http_lua_config_prefix);
    lua_setfield(L, -2, "prefix");

    lua_pushcfunction(L, njt_http_lua_config_data_prefix);
    lua_setfield(L, -2, "data_prefix");

    lua_pushcfunction(L, njt_http_lua_config_log_prefix);
    lua_setfield(L, -2, "log_prefix");

    lua_pushinteger(L, njet_version);
    lua_setfield(L, -2, "njet_version");

    lua_pushinteger(L, njt_http_lua_version);
...
static int
njt_http_lua_config_prefix(lua_State *L)
{
...
static int
njt_http_lua_config_data_prefix(lua_State *L)
{
...
static int
njt_http_lua_config_log_prefix(lua_State *L)
{
...
static int
njt_http_lua_config_configure(lua_State *L)
{
