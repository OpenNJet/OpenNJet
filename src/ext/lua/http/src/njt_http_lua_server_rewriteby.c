...
static njt_int_t njt_http_lua_server_rewrite_by_chunk(lua_State *L,
    njt_http_request_t *r);

njt_int_t
njt_http_lua_server_rewrite_handler(njt_http_request_t *r)
{
    njt_int_t                    rc;
    lua_State                   *L;
...
njt_int_t
njt_http_lua_server_rewrite_handler_inline(njt_http_request_t *r,
    njt_http_lua_srv_conf_t *lscf, lua_State *L)
{
    ...
    return njt_http_lua_server_rewrite_by_chunk(L, r);
}


njt_int_t
njt_http_lua_server_rewrite_handler_file(njt_http_request_t *r,
    njt_http_lua_srv_conf_t *lscf, lua_State *L)
{
    njt_int_t                        rc;
    u_char                          *script_path;
    ...
    if (njt_http_complex_value(r, &lscf->srv.server_rewrite_src,
                               &eval_src) != NJT_OK)
    {
        return NJT_ERROR;
    }
...
static njt_int_t
njt_http_lua_server_rewrite_by_chunk(lua_State *L, njt_http_request_t *r)
{
    int                      co_ref;
    lua_State               *co;
    njt_int_t                rc;
    ...
    ctx->context = NJT_HTTP_LUA_CONTEXT_SERVER_REWRITE;
