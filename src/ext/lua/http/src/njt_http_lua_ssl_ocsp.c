...
static int njt_http_lua_ssl_empty_status_callback(njt_ssl_conn_t *ssl_conn,
    void *data);
#endif


int
njt_http_lua_ffi_ssl_get_ocsp_responder_from_der_chain(
    const char *chain_data, size_t chain_len, unsigned char *out,
    size_t *out_size, char **err)
{
#ifndef NJT_HTTP_LUA_USE_OCSP
...
#endif  /* NJT_HTTP_LUA_USE_OCSP */
}


int
njt_http_lua_ffi_ssl_create_ocsp_request(const char *chain_data,
...
int
njt_http_lua_ffi_ssl_validate_ocsp_response(const u_char *resp,
...
#ifdef NJT_HTTP_LUA_USE_OCSP
static int
njt_http_lua_ssl_empty_status_callback(njt_ssl_conn_t *ssl_conn, void *data)
{
...
int
njt_http_lua_ffi_ssl_set_ocsp_status_resp(njt_http_request_t *r,
    const u_char *resp, size_t resp_len, char **err)
{
    ...
    *err = "no OCSP support";
    ...
    SSL_CTX_set_tlsext_status_cb(ctx,
                                 njt_http_lua_ssl_empty_status_callback);
