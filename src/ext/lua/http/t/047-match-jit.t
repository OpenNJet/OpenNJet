...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello, 1234", "([0-9]+)", "j")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello, world", "([0-9]+)", "j")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello, 1234", "([0-9]+)", "jo")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello, world", "([0-9]+)", "jo")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
