...
=== TEST 13: exit(0) in user thread (entry thread is still pending on njt.location.capture), with pending output
--- config
    location /lua {
        client_body_timeout 12000ms;
        content_by_lua '
...
=== TEST 16: exit in entry thread (user thread is still pending on njt.location.capture_multi), without pending output
--- config
    location /lua {
        client_body_timeout 12000ms;
        content_by_lua '
...
=== TEST 17: exit(444) in user thread (entry thread is still pending on njt.location.capture), with pending output
--- config
    location /lua {
        client_body_timeout 12000ms;
        content_by_lua '
...
=== TEST 18: exit(408) in user thread (entry thread is still pending on njt.location.capture), with pending output
--- config
    location /lua {
        client_body_timeout 12000ms;
        content_by_lua '
...
=== TEST 19: exit(499) in user thread (entry thread is still pending on njt.location.capture), with pending output
--- config
    location /lua {
        client_body_timeout 12000ms;
        content_by_lua '
