...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello", "(he|hell)", "d")
            if m then
                njt.say(m[0])
                njt.say(m[1])
                njt.say(m[2])
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello", "(he|hell)", "do")
            if m then
                njt.say(m[0])
                njt.say(m[1])
                njt.say(m[2])
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("hello", "(he|hell)", "jd")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("world", "(he|hell)", "d")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
...
--- config
    location /re {
        content_by_lua '
            local m = njt.re.match("world", "([0-9]+)", "do")
            if m then
                njt.say(m[0])
            else
                njt.say("not matched!")
