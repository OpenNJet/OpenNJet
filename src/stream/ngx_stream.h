...
typedef struct {
    ...
    ngx_stream_phase_t             phases[NJT_STREAM_LOG_PHASE + 1];
...
#define NJT_STREAM_MAIN_CONF_OFFSET  offsetof(ngx_stream_conf_ctx_t, main_conf)
#define NJT_STREAM_SRV_CONF_OFFSET   offsetof(ngx_stream_conf_ctx_t, srv_conf)
