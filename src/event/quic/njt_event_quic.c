...
njt_quic_apply_transport_params(njt_connection_t *c, njt_quic_tp_t *ctp)
{
    ...
    } else if (ctp->max_udp_payload_size > njt_quic_max_udp_payload(c)) {
        ctp->max_udp_payload_size = njt_quic_max_udp_payload(c);
    ...
    njt_quic_header_t *pkt)
{
    ...
    qc->path_validation.handler = njt_quic_path_validation_handler;
