...
static njt_bpf_reloc_t bpf_reloc_prog_njt_quic_reuseport_helper[] = {
    { "njt_quic_sockmap", 55 },
};

static struct bpf_insn bpf_insn_prog_njt_quic_reuseport_helper[] = {
...
njt_bpf_program_t njt_quic_reuseport_helper = {
    .relocs = bpf_reloc_prog_njt_quic_reuseport_helper,
    .nrelocs = sizeof(bpf_reloc_prog_njt_quic_reuseport_helper)
               / sizeof(bpf_reloc_prog_njt_quic_reuseport_helper[0]),
    .ins = bpf_insn_prog_njt_quic_reuseport_helper,
    .nins = sizeof(bpf_insn_prog_njt_quic_reuseport_helper)
            / sizeof(bpf_insn_prog_njt_quic_reuseport_helper[0]),
    .license = "BSD",
