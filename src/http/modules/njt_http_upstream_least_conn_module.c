...
static njt_int_t njt_http_upstream_init_least_conn_peer(njt_http_request_t *r,
    njt_http_upstream_srv_conf_t *us);
static njt_int_t njt_http_upstream_get_least_conn_peer(
    njt_peer_connection_t *pc, void *data);
static char *njt_http_upstream_least_conn(njt_conf_t *cf, njt_command_t *cmd,
    void *conf);


static njt_command_t  njt_http_upstream_least_conn_commands[] = {

    { njt_string("least_conn"),
      NJT_HTTP_UPS_CONF|NJT_CONF_NOARGS,
      njt_http_upstream_least_conn,
      0,
      0,
      NULL },
...
static njt_http_module_t  njt_http_upstream_least_conn_module_ctx = {
...
njt_module_t  njt_http_upstream_least_conn_module = {
    NJT_MODULE_V1,
    &njt_http_upstream_least_conn_module_ctx, /* module context */
    njt_http_upstream_least_conn_commands, /* module directives */
...
static njt_int_t
njt_http_upstream_init_least_conn(njt_conf_t *cf,
    njt_http_upstream_srv_conf_t *us)
{
    ...
    us->peer.init = njt_http_upstream_init_least_conn_peer;
...
static njt_int_t
njt_http_upstream_init_least_conn_peer(njt_http_request_t *r,
    njt_http_upstream_srv_conf_t *us)
{
    ...
    r->upstream->peer.get = njt_http_upstream_get_least_conn_peer;
...
static njt_int_t
njt_http_upstream_get_least_conn_peer(njt_peer_connection_t *pc, void *data)
{
...
failed:
    ...
    if (peers->next) {
        ...
        rc = njt_http_upstream_get_least_conn_peer(pc, rrp);
...
static char *
njt_http_upstream_least_conn(njt_conf_t *cf, njt_command_t *cmd, void *conf)
{
