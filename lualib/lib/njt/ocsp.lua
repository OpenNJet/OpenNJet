...
ffi.cdef[[
int njt_http_lua_ffi_ssl_get_ocsp_responder_from_der_chain(
    const char *chain_data, size_t chain_len, char *out, size_t *out_size,
    char **err);

int njt_http_lua_ffi_ssl_create_ocsp_request(const char *chain_data,
    size_t chain_len, unsigned char *out, size_t *out_size, char **err);

int njt_http_lua_ffi_ssl_validate_ocsp_response(const unsigned char *resp,
    size_t resp_len, const char *chain_data, size_t chain_len,
    unsigned char *errbuf, size_t *errbuf_size);

int njt_http_lua_ffi_ssl_set_ocsp_status_resp(njt_http_request_t *r,
...
function _M.get_ocsp_responder_from_der_chain(certs, maxlen)
    ...
    local rc = C.njt_http_lua_ffi_ssl_get_ocsp_responder_from_der_chain(certs,
...
function _M.create_ocsp_request(certs, maxlen)
    ...
    local rc = C.njt_http_lua_ffi_ssl_create_ocsp_request(certs,
                                                          #certs, buf, sizep,
                                                          errmsg)
...
function _M.validate_ocsp_response(resp, chain, max_errmsg_len)
    ...
    local rc = C.njt_http_lua_ffi_ssl_validate_ocsp_response(
...
function _M.set_ocsp_status_resp(ocsp_resp)
    ...
    local rc = C.njt_http_lua_ffi_ssl_set_ocsp_status_resp(r, ocsp_resp,
                                                           #ocsp_resp,
                                                           errmsg)
