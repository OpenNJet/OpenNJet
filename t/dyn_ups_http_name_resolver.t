...
my $json_payload = '{
  "type": "add",
  "upstream_name": "back",
  "upstream_body": "zone back-zone 10m;" 
}';  

my $r;

$r = http(<<EOF);
POST /api/v1/dyn_ups HTTP/1.1
Host: localhost
Connection: close
...
$r_server = http(<<EOF);
POST /api/v1/upstream_api/http/upstreams/back/servers/ HTTP/1.1
Host: localhost
Connection: close
...
like($r_server, qr/"server":"test.muti.com:80"/, 'post upstream');



sleep 5;
my $json_url = '/api/v1/upstream_api/http/upstreams/back/';  
