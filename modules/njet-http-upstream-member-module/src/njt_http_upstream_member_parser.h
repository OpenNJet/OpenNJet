...
#ifndef NJT_HTTP_UPSTREAM_MEMBER_PARSER_H
#define NJT_HTTP_UPSTREAM_MEMBER_PARSER_H
#include <stdint.h>
#include <stdbool.h>
#include "njt_core.h"
#include "js2c_njet_builtins.h"
/* ===================== Generated type declarations ===================== */
typedef njt_str_t upstream_member_server_t;

typedef int64_t upstream_member_weight_t;
typedef int64_t upstream_member_max_conns_t;
typedef int64_t upstream_member_max_fails_t;
typedef bool upstream_member_down_t;
typedef bool upstream_member_backup_t;
typedef bool upstream_member_drain_t;
typedef njt_str_t upstream_member_fail_timeout_t;

typedef njt_str_t upstream_member_slow_start_t;
...
typedef struct upstream_member_t_s {
    upstream_member_server_t server;
    upstream_member_weight_t weight;
    upstream_member_max_conns_t max_conns;
    upstream_member_max_fails_t max_fails;
    upstream_member_down_t down;
    upstream_member_backup_t backup;
    upstream_member_drain_t drain;
