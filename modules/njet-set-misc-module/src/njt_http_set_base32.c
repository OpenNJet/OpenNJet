...
static void encode_base32(size_t slen, u_char *src, size_t *dlen, u_char *dst,
    njt_flag_t padding, njt_str_t *alphabet);
static int decode_base32(size_t slen, u_char *src, size_t *dlen, u_char *dst,
    u_char *basis32);


njt_int_t
njt_http_set_misc_encode_base32(njt_http_request_t *r, njt_str_t *res,
...
njt_int_t
njt_http_set_misc_decode_base32(njt_http_request_t *r, njt_str_t *res,
    njt_http_variable_value_t *v)
{
    size_t                   len;
    u_char                  *p;
...
/* See the implementation in src/core/njt_string.c's
 * njt_(encode|decode)_base64() for details. */
