...
#ifndef PARSER_CACHE_DYNLOC_H
#define PARSER_CACHE_DYNLOC_H
#include <stdint.h>
#include <stdbool.h>
#include "njt_core.h"
#include "js2c_njet_builtins.h"
/* ===================== Generated type declarations ===================== */
typedef enum cache_dyn_location_type_t_e{
    CACHE_DYN_LOCATION_TYPE_ADD,
    CACHE_DYN_LOCATION_TYPE_DEL
} cache_dyn_location_type_t;

typedef njt_str_t cache_dyn_location_addr_port_t;

typedef njt_str_t cache_dyn_location_server_name_t;

typedef njt_str_t cache_dyn_location_locations_item_location_rule_t;

typedef njt_str_t cache_dyn_location_locations_item_location_name_t;

typedef njt_str_t cache_dyn_location_locations_item_location_body_t;

typedef njt_str_t cache_dyn_location_locations_item_proxy_pass_t;

typedef struct cache_dyn_location_locations_item_t_s {
    cache_dyn_location_locations_item_location_rule_t location_rule;
    cache_dyn_location_locations_item_location_name_t location_name;
    cache_dyn_location_locations_item_location_body_t location_body;
    cache_dyn_location_locations_item_proxy_pass_t proxy_pass;
...
} cache_dyn_location_locations_item_t;

typedef njt_array_t  cache_dyn_location_locations_t;
typedef struct cache_dyn_location_t_s {
    cache_dyn_location_type_t type;
    cache_dyn_location_addr_port_t addr_port;
    cache_dyn_location_server_name_t server_name;
    cache_dyn_location_locations_t *locations;
...
int add_item_cache_dyn_location_locations(cache_dyn_location_locations_t *src, cache_dyn_location_locations_item_t* items);
