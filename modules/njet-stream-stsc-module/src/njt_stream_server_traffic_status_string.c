...
uintptr_t
njt_stream_server_traffic_status_escape_json(u_char *dst, u_char *src, size_t size)
{
    u_char      ch;
    njt_uint_t  len;
...
njt_int_t
njt_stream_server_traffic_status_escape_json_pool(njt_pool_t *pool,
    njt_str_t *buf, njt_str_t *dst)
{
    ...
    p = (u_char *) njt_stream_server_traffic_status_escape_json(p, dst->data, dst->len);
...
njt_int_t
njt_stream_server_traffic_status_copy_str(njt_pool_t *pool,
    njt_str_t *buf, njt_str_t *dst)
{
    u_char  *p;
...
njt_int_t
njt_stream_server_traffic_status_replace_chrc(njt_str_t *buf,
    u_char in, u_char to)
{
    size_t   len;
    u_char  *p;
...
njt_int_t
njt_stream_server_traffic_status_replace_strc(njt_str_t *buf,
