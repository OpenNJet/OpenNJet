...
static bool parse_locationDef_accessIpv4(njt_pool_t *pool, parse_state_t *parse_state, locationDef_accessIpv4_t *out, njt_str_t *err_str) {
    ...
    for (i = 0; i < n; ++i) {
        ...
        printf("alloctate elts ((locationDef_accessIpv4_item_t**)out->elts)[i] = njt_palloc(pool, sizeof(locationDef_accessIpv4_item_t));\n");
...
static bool parse_locationDef_accessIpv6(njt_pool_t *pool, parse_state_t *parse_state, locationDef_accessIpv6_t *out, njt_str_t *err_str) {
    ...
    for (i = 0; i < n; ++i) {
        // TODO CHECK write later
        printf("current i %d, n = %d\n", i, parse_state->tokens[parse_state->current_token].size);
        printf("alloctate elts ((locationDef_accessIpv6_item_t**)out->elts)[i] = njt_palloc(pool, sizeof(locationDef_accessIpv6_item_t));\n");
...
static void marshal_locationDef_accessIpv4_item_rule(locationDef_accessIpv4_item_rule_t *out, njt_int_t flags) {
...
static void marshal_locationDef_accessIpv4_item_addr(locationDef_accessIpv4_item_addr_t *out, njt_int_t flags) {
    char *buf = malloc((*out)->len + 1);
    njt_memcpy(buf, (*out)->data, (*out)->len);
    printf("\"%s\"", (*out)->data);
    free(buf);
...
static void marshal_locationDef_accessIpv4_item_mask(locationDef_accessIpv4_item_mask_t *out, njt_int_t flags) {
    char *buf = malloc((*out)->len + 1);
    njt_memcpy(buf, (*out)->data, (*out)->len);
    printf("\"%s\"", (*out)->data);
    free(buf);
...
static void marshal_locationDef_accessIpv4_item(locationDef_accessIpv4_item_t *out, njt_int_t flags) {
    njt_int_t omit;
    njt_int_t count = 0;
    if (out == NULL) {
        printf("null");
    ...
    if (omit == 0) {
        printf("\"rule\":");
        marshal_locationDef_accessIpv4_item_rule((&out->rule), flags);
        printf(",");
        count++;
    }
    omit = 0;
    ...
    if (omit == 0) {
        printf("\"addr\":");
        marshal_locationDef_accessIpv4_item_addr((&out->addr), flags);
        printf(",");
        count++;
    }
    omit = 0;
    ...
    if (omit == 0) {
        printf("\"mask\":");
        marshal_locationDef_accessIpv4_item_mask((&out->mask), flags);
        printf(",");
        count++;
    }
    if (count != 0) {
...
static void marshal_locationDef_accessIpv4(locationDef_accessIpv4_t *out, njt_int_t flags) {
    njt_uint_t i;
    njt_int_t count = 0;
    njt_int_t omit;
    if (out == NULL) {
    ...
    for (i = 0; i < out->nelts; ++i) {
        ...
        if (omit == 0) {
            marshal_locationDef_accessIpv4_item(((locationDef_accessIpv4_item_t**)out->elts)[i], flags);
            printf(",");
            count++;
        }
    }
...
static void marshal_locationDef_accessIpv6_item_rule(locationDef_accessIpv6_item_rule_t *out, njt_int_t flags) {
...
static void marshal_locationDef_accessIpv6_item_addr(locationDef_accessIpv6_item_addr_t *out, njt_int_t flags) {
    char *buf = malloc((*out)->len + 1);
    njt_memcpy(buf, (*out)->data, (*out)->len);
    printf("\"%s\"", (*out)->data);
    free(buf);
...
static void marshal_locationDef_accessIpv6_item_mask(locationDef_accessIpv6_item_mask_t *out, njt_int_t flags) {
    char *buf = malloc((*out)->len + 1);
    njt_memcpy(buf, (*out)->data, (*out)->len);
    printf("\"%s\"", (*out)->data);
    free(buf);
...
static void marshal_locationDef_accessIpv6_item(locationDef_accessIpv6_item_t *out, njt_int_t flags) {
    njt_int_t omit;
    njt_int_t count = 0;
    if (out == NULL) {
        printf("null");
    ...
    if (omit == 0) {
        printf("\"rule\":");
        marshal_locationDef_accessIpv6_item_rule((&out->rule), flags);
        printf(",");
        count++;
    }
    omit = 0;
    ...
    if (omit == 0) {
        printf("\"addr\":");
        marshal_locationDef_accessIpv6_item_addr((&out->addr), flags);
        printf(",");
        count++;
    }
    omit = 0;
    ...
    if (omit == 0) {
        printf("\"mask\":");
        marshal_locationDef_accessIpv6_item_mask((&out->mask), flags);
        printf(",");
        count++;
    }
    if (count != 0) {
...
static void marshal_locationDef_accessIpv6(locationDef_accessIpv6_t *out, njt_int_t flags) {
    njt_uint_t i;
    njt_int_t count = 0;
    njt_int_t omit;
    if (out == NULL) {
    ...
    for (i = 0; i < out->nelts; ++i) {
        ...
        if (omit == 0) {
            marshal_locationDef_accessIpv6_item(((locationDef_accessIpv6_item_t**)out->elts)[i], flags);
            printf(",");
            count++;
        }
    }
...
static void marshal_locationDef(locationDef_t *out, njt_int_t flags) {
    ...
    if (omit == 0) {
        printf("\"accessIpv4\":");
        marshal_locationDef_accessIpv4((out->accessIpv4), flags);
        printf(",");
        count++;
    }
    omit = 0;
    ...
    if (omit == 0) {
        printf("\"accessIpv6\":");
        marshal_locationDef_accessIpv6((out->accessIpv6), flags);
        printf(",");
        count++;
    }
    omit = 0;
...
static void to_oneline_json_locationDef_accessIpv4_item_rule(locationDef_accessIpv4_item_rule_t *out, njt_str_t* buf, njt_int_t flags) {
    ...
    char* cur = (char *)buf->data + buf->len;
    if (*out == LOCATIONDEF_ACCESSIPV4_ITEM_RULE_ALLOW) {
        len = sprintf(cur, "\"allow\"");
        buf->len += len;
        cur += len;
        return;
    }
    if (*out == LOCATIONDEF_ACCESSIPV4_ITEM_RULE_DENY) {
        len = sprintf(cur, "\"deny\"");
        buf->len += len;
        cur += len;
        return;
    }
...
static bool parse_dynbwlist_servers_item_listens(njt_pool_t *pool, parse_state_t *parse_state, dynbwlist_servers_item_listens_t *out, njt_str_t *err_str) {
    ...
    for (i = 0; i < n; ++i) {
        // TODO CHECK write later
        printf("current i %d, n = %d\n", i, parse_state->tokens[parse_state->current_token].size);
        printf("alloctate elts ((dynbwlist_servers_item_listens_item_t**)out->elts)[i] = njt_palloc(pool, sizeof(njt_str_t));\n");
...
static bool parse_dynbwlist_servers_item_serverNames(njt_pool_t *pool, parse_state_t *parse_state, dynbwlist_servers_item_serverNames_t *out, njt_str_t *err_str) {
    ...
    for (i = 0; i < n; ++i) {
        // TODO CHECK write later
        printf("current i %d, n = %d\n", i, parse_state->tokens[parse_state->current_token].size);
        printf("alloctate elts ((dynbwlist_servers_item_serverNames_item_t**)out->elts)[i] = njt_palloc(pool, sizeof(njt_str_t));\n");
...
static bool parse_dynbwlist_servers_item_locations(njt_pool_t *pool, parse_state_t *parse_state, dynbwlist_servers_item_locations_t *out, njt_str_t *err_str) {
    ...
    for (i = 0; i < n; ++i) {
        // TODO CHECK write later
        printf("current i %d, n = %d\n", i, parse_state->tokens[parse_state->current_token].size);
        printf("alloctate elts ((dynbwlist_servers_item_locations_item_t**)out->elts)[i] = njt_palloc(pool, sizeof(locationDef_t));\n");
...
static bool parse_dynbwlist_servers(njt_pool_t *pool, parse_state_t *parse_state, dynbwlist_servers_t *out, njt_str_t *err_str) {
    ...
    for (i = 0; i < n; ++i) {
        // TODO CHECK write later
        printf("current i %d, n = %d\n", i, parse_state->tokens[parse_state->current_token].size);
        printf("alloctate elts ((dynbwlist_servers_item_t**)out->elts)[i] = njt_palloc(pool, sizeof(dynbwlist_servers_item_t));\n");
