...
function _M.new(self)
    local _cookie = njt.var.http_cookie
    --if not _cookie then
...
function _M.set(self, cookie)
    ...
    local set_cookie = njt_header['Set-Cookie']
    ...
    elseif set_cookie_type == "table" then
        ...
        njt_header['Set-Cookie'] = cookie_str
    end
    return true
end
