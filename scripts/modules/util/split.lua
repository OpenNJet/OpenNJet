...
-- http://nginx.org/en/docs/http/njt_http_upstream_module.html#example
-- CAVEAT: nginx is giving out : instead of , so the docs are wrong
-- 127.0.0.1:26157 : 127.0.0.1:26157 , njt.var.upstream_addr
-- 200 : 200 , njt.var.upstream_status
-- 0.00 : 0.00, njt.var.upstream_response_time
...
-- Splits an NJET $upstream_addr and returns an array of tables
