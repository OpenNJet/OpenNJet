...
NJET_MODULES="$NJET_MODULES --add-dynamic-module=./modules/njet-helper-dynconf-update-module"
...
LIB_SRC_PATH=" --with-openssl=auto/lib/tongsuo  --with-go-dynconf-path=/home/ubuntu/go/src/gitee.com/liismn/json_parser/conf_merge"
