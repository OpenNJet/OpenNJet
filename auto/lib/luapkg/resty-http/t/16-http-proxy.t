...
--- config
    location /lua {
        content_by_lua_block {
            ...
            njt.say(httpc:get_proxy_uri("http", "example.com"))
        }
    }
--- request
GET /lua
    ...
    location /lua {
        content_by_lua_block {
            ...
            local function test_no_proxy(scheme, host, no_proxy)
                ...
                njt.say("scheme: ", scheme, ", host: ", host, ", no_proxy: ", no_proxy, ", proxy_uri: ", proxy_uri)
            end
    ...
    location /lua {
        content_by_lua_block {
            ...
            if not err then
                ...
                njt.log(njt.ERR, "unexpected success")
                return
            end
...
--- http_config
    ...
    server {
        ...
        location / {
            content_by_lua_block {
                njt.print(njt.var.http_proxy_authorization or "no-header")
            }
        }
    }
--- config
