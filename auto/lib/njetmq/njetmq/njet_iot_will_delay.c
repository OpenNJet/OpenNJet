...
static struct iot_will_delay_list *delay_list = NULL;
static time_t last_check = 0;

static int will_delay__cmp(struct iot_will_delay_list *i1, struct iot_will_delay_list *i2)
{
...
{
	struct iot_will_delay_list *item;
	...
	item = mosquitto__calloc(1, sizeof(struct iot_will_delay_list));
	if (!item)
...
{
	struct iot_will_delay_list *item, *tmp;
