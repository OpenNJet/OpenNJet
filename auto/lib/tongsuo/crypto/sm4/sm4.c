 ...
 *
 * Copyright 2023 The Tongsuo Project. All Rights Reserved.
 * Provided SM4NI optimization.
 *
 ...
 *
 * The SM4NI feature is inspired by Markku-Juhani O. Saarinen and his demo.
 */
...
void SM4_encrypt_affine_ni(const uint8_t *in, uint8_t *out, const SM4_KEY *ks)
{
    /*  nibble mask */
