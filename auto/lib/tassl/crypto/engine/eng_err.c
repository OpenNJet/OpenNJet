...
static const ERR_STRING_DATA ENGINE_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_CONVERT_PRIVATE_KEY, 0),
     "ENGINE_convert_private_key"},
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_SSL_GENERATE_MASTER_SECRET, 0),
     "ENGINE_ssl_generate_master_secret"},
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_TABLE_REGISTER, 0),
     "engine_table_register"},
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_TLS1_GENERATE_KEY_BLOCK, 0),
     "ENGINE_tls1_generate_key_block"},
